...
export class SiteFormsComponent implements OnInit {
  ...
  new_stage: Stage = new Stage(undefined,undefined,undefined,undefined,undefined,undefined,undefined,undefined);
  ...
  wait(ms:number){
   ...
   while(end < start + ms) {
    ...
    newStageOpen() {
      this.getMainStages();
        this.new_stage = new Stage(undefined,undefined,undefined,undefined,undefined,undefined,undefined, undefined);
